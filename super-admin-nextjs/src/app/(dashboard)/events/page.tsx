          ...
          <CardHeader className="pb-3 px-4 sm:px-6">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <Button variant="outline" size="sm" className="h-9 flex-1 lg:flex-none hover:bg-slate-50 transition-colors">
                  <Filter className="mr-2 h-4 w-4" /> Lọc
                </Button>
                <div className="h-9 px-3 flex items-center justify-center border rounded-md bg-muted/30 text-[10px] font-bold uppercase tracking-wider text-muted-foreground flex-none">
