    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6 pb-10">
      <motion.div variants={item} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <Button size="sm" className="flex-1 sm:flex-none active:scale-95 transition-transform">Email hàng loạt</Button>
        </div>
      </motion.div>
                        ...
                        <TableCell className="text-right p-0 sm:px-6 absolute top-4 right-4 sm:relative sm:top-auto sm:right-auto leading-none">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-48">
                              <DropdownMenuItem className="cursor-pointer">Xem vé điện tử</DropdownMenuItem>
                              <DropdownMenuItem className="cursor-pointer">Gửi lại email xác nhận</DropdownMenuItem>
                              <DropdownMenuSeparator />
                              <DropdownMenuItem className="text-red-500 focus:text-red-500 cursor-pointer">Hủy đăng ký này</DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
                        </TableCell>
                      </motion.tr>
