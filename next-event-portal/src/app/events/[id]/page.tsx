        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-4 lg:pl-4">
            <div className="sticky top-28 space-y-8">
              ...
              {/* Organizer Card (New) */}
              <div className="bg-slate-900 rounded-2xl md:rounded-[2.5rem] p-6 md:p-8 text-white">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] md:tracking-[0.4em] text-red-500 mb-4 md:mb-6 font-mono">
                  Organizer
                </p>
                <div className="flex items-center gap-4">
                  <div className="h-10 w-10 md:h-12 md:w-12 rounded-full bg-red-600 flex items-center justify-center font-black italic text-lg md:text-xl shrink-0">
                    VA
                  </div>
                  <div>
                    <h4 className="font-black italic uppercase tracking-tighter leading-none text-sm md:text-base">Vietnam Academic</h4>
                    <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-1">Certified Partner</p>
                  </div>
                </div>
              </div>
            </div>
