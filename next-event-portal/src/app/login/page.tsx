...
import { Mail, ShieldCheck, Lock, UserCog } from 'lucide-react';
...
export default function Login() {
  ...
  const loginAs = async (mockEmail: string) => {
    setEmail(mockEmail);
    setPassword('password123'); // Preset password for mock
    setIsSubmitting(true);
    setErrorMsg(null);
    try {
          ...
          <div className="p-8 md:p-12 text-center space-y-8">
            ...
            <form onSubmit={handleLogin} className="space-y-6 text-left">
              ...
              >
                ...
                {isSubmitting ? 'Äang xÃ¡c thá»±c...' : t('loginWithEmail')}
              </button>
            </form>

            <div className="pt-4 border-t border-slate-100 space-y-4">
              <p className="text-[10px] font-bold text-slate-400">ÄÄƒng nháº­p nhanh (Demo)</p>
